...
export default function EntityModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className={`p-0 ${sizes[size]} max-h-[92vh] overflow-hidden flex flex-col`}>
        <DialogHeader className="border-b border-[hsl(var(--admin-border))] px-6 py-4 space-y-1">
